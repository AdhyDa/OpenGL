...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("src/4.4.lighting_maps.vs", "src/4.4.lighting_maps.fs");
    Shader lightCubeShader("src/4.4.light_cube.vs", "src/4.4.light_cube.fs");
    ...
    unsigned int emissionMap = loadTexture("img/matrix.jpg");
